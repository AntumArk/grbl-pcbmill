...
//#define HOMING_CYCLE_0 (1<<Z_AXIS)                // REQUIRED: First move Z to clear workspace. Disable for solenoid system
...
#define MAX_FEED_RATE_OVERRIDE          300 // Percent of programmed feed rate (100-255). Usually 120% or 200%
